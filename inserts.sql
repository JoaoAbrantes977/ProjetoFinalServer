...
INSERT INTO `drone`(`propulsao`, `num_rotores`, `peso`, `alcance_max`, `altitude_max`, `tempo_voo_max`, `tempo_bateria`, `velocidade_max`, `velocidade_ascente`, `velocidade_descendente`, `resistencia_vento`, `temperatura`, `sistema_localizacao`, `tipo_camera`, `comprimento_img`, `largura_img`, `fov`, `resolucao_cam`, `createdOn`, `updatedOn`, `id_fabricante`) VALUES ('Multi-rotor',4,734.00,13.00,5.00,'27','21','18','5','3','10',40,'GPS/GLONASS','GIMBAL',4000,3000,78,'4k',CURDATE(),CURDATE(),1);